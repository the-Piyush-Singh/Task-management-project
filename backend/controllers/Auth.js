...
const Register = async (req, res) => {
    try {
        ...
        if (!FullName || !email || !password || !imagePath) {
        ...
        // const cloudinaryResult = await FileUploadToCloudinary(imagePath, 'user_profiles');
        ...
        const newUser = new UserModal({
            ...
            profile: imagePath // or imageUrl if using Cloudinary
        });

        await newUser.save();

        // Delete local image after upload (optional)
        // fs.unlinkSync(`path/to/uploads/${imagePath}`);
